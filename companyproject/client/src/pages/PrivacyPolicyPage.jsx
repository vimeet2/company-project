...
export default function PrivacyPolicyPage() {
  return (
    <div className="p-8 min-h-screen flex flex-col justify-center bg-gradient-to-r from-[#FF9933] via-[#FFFFFF] to-[#138808] text-gray-900">
      <div
        className="bg-white rounded-lg shadow-lg p-8 md:p-12 max-w-2xl mx-auto transform transition-transform duration-300 hover:scale-105"
      >
        <h1 className="text-3xl font-bold mb-6 text-center uppercase text-[#FF9933]">
          Privacy Policy
        </h1>

        <h2 className="text-2xl font-semibold mb-4 text-[#138808]">Introduction</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold mb-4 text-[#138808]">Information We Collect</h2>
        ...
        <h2 className="text-2xl font-semibold mb-4 text-[#138808]">How We Use Your Information</h2>
        <ul className="list-disc list-inside mb-4">
          <li>
        ...
        <h2 className="text-2xl font-semibold mb-4 text-[#138808]">How We Protect Your Information</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold mb-4 text-[#138808]">Sharing Your Information</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold mb-4 text-[#138808]">Your Rights</h2>
        <ul className="list-disc list-inside mb-4">
          <li>
        ...
        <h2 className="text-2xl font-semibold mb-4 text-[#138808]">Changes to This Policy</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold mb-4 text-[#138808]">Contact Us</h2>
        <p>
