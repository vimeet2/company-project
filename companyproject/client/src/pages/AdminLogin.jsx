...
//   return (
//     <div className="flex h-screen items-center justify-center bg-gradient-to-r from-purple-600 to-blue-700">
...
//             <Checkbox id="remember" className="accent-purple-600" />
...
//           <Button
//             type="submit"
//             className="w-full bg-purple-600 text-white rounded-md py-2 hover:bg-purple-700 transition duration-200 font-semibold"
//             disabled={loading}
//           >
...
//   return (
//     <div className="flex h-screen items-center justify-center bg-gradient-to-r from-indigo-500 to-blue-600">
//       <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-2xl transition-all duration-300 ease-in-out transform hover:scale-105">
...
//               type="text"
//               placeholder="Enter your username"
//               className="w-full rounded-md p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200"
//               value={username}
//               onChange={(e) => setUsername(e.target.value)}
//               required
//             />
...
//           <Button
//             type="submit"
//             className="w-full bg-blue-600 text-white rounded-md py-2 hover:bg-blue-700 transition duration-200 font-semibold"
//             disabled={loading}
//           >
//             {loading ? "Logging in..." : "Login"}
//           </Button>
...
//   return (
//     <div className="flex h-screen items-center justify-center bg-gradient-to-r from-[#00C6FF] to-[#0072FF]">
//       <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-xl transition-all duration-300 ease-in-out transform hover:scale-105">
//         <h1 className="text-4xl font-extrabold text-center text-gray-800 mb-8">
//           Admin Login
//         </h1>
...
//               type="text"
//               placeholder="Enter your username"
//               className="w-full rounded-md p-3 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#00C6FF] transition duration-200"
//               value={username}
//               onChange={(e) => setUsername(e.target.value)}
//               required
//             />
...
//           </div>
//           <div className="flex items-center gap-2">
//             <Checkbox id="remember" className="accent-[#00C6FF]" />
//             <Label htmlFor="remember" className="text-gray-700">
//               Remember me
//             </Label>
//           </div>
//           <Button
//             type="submit"
//             className="w-full bg-[#00C6FF] text-white rounded-md py-2 hover:bg-[#00C6FF]/80 transition duration-200 font-semibold"
//             disabled={loading}
//           >
//             {loading ? "Logging in..." : "Login"}
//           </Button>
